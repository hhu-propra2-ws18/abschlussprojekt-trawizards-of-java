...
E-Mails zu versenden funktioniert im ProPra2-Netzwerk nicht, es ist eine funktionierende Internetverbindung erforderlich.
Die Anwendung kann mit 'docker-compose up' gestartet werden. +
Die Startseite ist dann unter 'localhost:8080' erreichbar. +
Der einzige bereits existente Benutzer ist ein Admin mit folgenden Anmeldedaten: +
Benutzername: 'root' Passwort:'1234' +
Weitere Nutzer ohne Admin-Rechte lassen sich über die Registrieren-Schaltfläche hinzufügen. +
