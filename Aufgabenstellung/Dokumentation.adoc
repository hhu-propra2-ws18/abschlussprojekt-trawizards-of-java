...
## Klassen
Die folgenden Skizzen sollten wohl am besten veranschaulichen können, wie die Klassen zusammenhängen. +

Der erste Graph stellt eine frühere Entwicklungsphase dar: +

image::Klassen.png[Klassen]

Der zweite Graph stellt die Klassenstruktur zu Fertigstellung des Projekts dar: +
